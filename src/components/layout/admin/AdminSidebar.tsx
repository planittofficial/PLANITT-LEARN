  ...
  const content = (
    <div className="flex flex-col h-full bg-surface border-r border-borderSubtle">
      ...
      <div className="p-4 border-t border-borderSubtle space-y-4">
        ...
        <div className="flex items-center justify-between rounded-lg border border-borderSubtle px-3 py-2 text-xs text-textMuted">
          <span>Theme</span>
        ...
        <div className="flex flex-col gap-2 text-xs">
          ...
          {user ? (
            <button
              onClick={() => void logout()}
              className="flex items-center justify-center gap-1.5 rounded-lg border border-red-200 py-2.5 text-red-600 transition hover:border-red-300 hover:bg-red-50 dark:border-red-500/30 dark:text-red-300 dark:hover:bg-red-500/10"
            >
