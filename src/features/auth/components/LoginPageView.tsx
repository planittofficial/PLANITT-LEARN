...
export function LoginPageView() {
  ...
  return (
    <>
      ...
      <div className="relative flex min-h-screen flex-col items-center justify-center bg-appBase px-4 py-10 overflow-hidden">
        {/* Background Overlay */}
          ...
          {devStandalone ? (
            <div className="border-t border-borderSubtle pt-4 space-y-3">
              ...
              <button
                ...
                disabled={submitting}
                className="w-full rounded-lg border border-borderSubtle px-4 py-2.5 text-sm text-textSecondary hover:border-brand/40 hover:text-brand disabled:opacity-50 transition"
              >
