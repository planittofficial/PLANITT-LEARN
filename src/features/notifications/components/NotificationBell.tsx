  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      >
        ...
        {unreadCount > 0 ? (
          <span className="absolute -right-0.5 -top-0.5 flex h-4 min-w-4 items-center justify-center rounded-full bg-brand px-1 text-[10px] font-bold text-brandForeground">
