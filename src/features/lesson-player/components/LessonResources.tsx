        ...
        {resources.map((r) => (
          <li key={r.label}>
            <a
              ...
              className="flex items-center gap-2 rounded-lg border border-borderSubtle/60 px-3 py-2 text-sm text-textSecondary transition hover:border-brand/30 hover:text-brand"
            >
